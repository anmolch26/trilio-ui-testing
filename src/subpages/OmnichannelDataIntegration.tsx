      ...
      <main className="container mx-auto px-4 pt-24 pb-8">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Omnichannel Data Integration</h1>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 mb-12">
            ...
            <div className="md:w-1/2 p-8">
              <p className="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
                Omnichannel data integration allows businesses to seamlessly connect and consolidate data from platforms like Amazon, Shopify, Walmart, Google Ads, and Facebook Ads into a single, unified dashboard. By bringing together sales, marketing, and customer engagement data from these diverse sources, businesses can gain real-time insights into performance across all channels. This centralized view eliminates the need for manual data collection and enables more efficient analysis, better decision-making, and enhanced campaign optimization. With integrated data, companies can identify trends, allocate budgets more effectively, and deliver consistent customer experiences across every touchpoint.
              </p>
            </div>
...
export default OmnichannelDataIntegration; 