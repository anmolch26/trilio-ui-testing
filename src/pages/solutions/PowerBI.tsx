  ...
  <PageLayout backgroundClass="bg-[#F2C811]">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex-1 text-left text-black max-w-xl">
          <div className="uppercase tracking-widest font-bold text-sm mb-4 text-[#1f1f1f]">
            POWER BI ANALYTICS & BI INTEGRATION
          </div>
          <h1 className="text-5xl lg:text-7xl font-extrabold mb-6">
            AI-POWERED POWER BI DASHBOARDS & SEMANTIC MODELING
          </h1>
          <p className="text-2xl mb-8 font-light leading-snug">
            Connect your commerce, marketing, and operations data to Power BI
            with governed metrics, DAX models, and automated refresh for
            real-time decision-making across teams.
          </p>
          <ThemeButton
            variant="primary"
            size="lg"
        ...
        <div className="flex-1 flex justify-center items-center mt-12 lg:mt-0">
          <img
            src="/hero-image.jpg"
            alt="Power BI Dashboards & Reporting"
    ...
    <section className="bg-white py-20 px-4 relative z-20 -mt-16 rounded-t-3xl rounded-b-3xl">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-extrabold text-center text-[#21005c] mb-6">
          AI-Driven Power BI Analytics & Performance Insights
        </h2>
        <p className="text-lg md:text-xl text-center text-gray-700 max-w-3xl mx-auto mb-12">
          ...
          enable self-serve analytics on trusted, curated data sources with a
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mt-8">
          ...
          <div className="flex-1 flex justify-center">
            <img
              ...
              alt="Power BI Analytics and Business Results"
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b pb-4">
                <span className="font-bold text-xl text-[#21005c]">
                  DAX semantic models with governed KPIs
                </span>
                <span className="text-3xl text-[#F2C811] font-bold">+</span>
              </div>
              <div className="flex items-center justify-between border-b pb-4">
                <span className="font-bold text-xl text-[#21005c]">
                  Power Query transformations & dataflows
                </span>
                <span className="text-3xl text-[#F2C811] font-bold">+</span>
              </div>
              <div className="flex items-center justify-between border-b pb-4">
                <span className="font-bold text-xl text-[#21005c]">
                  Scheduled refresh, alerts, and RLS security
                </span>
                <span className="text-3xl text-[#F2C811] font-bold">+</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="font-bold text-xl text-[#21005c]">
                  Pixel-perfect paginated reports (RDL)
                </span>
                <span className="text-3xl text-[#F2C811] font-bold">+</span>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1">
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#21005c] mb-6">
            Unify Sources, Models, Dashboards, and RLS
          </h2>
          <p className="text-lg text-gray-700 mb-6">
            We build a robust semantic model, define metrics, and set up Power
            Query dataflows for reliable refresh. Embed reports with row-level
            security and role-based access for every audience.
          </p>
          <p className="text-lg text-gray-700">
            From source integration to DAX measures and performance tuning, we
            deliver a scalable foundation for Power BI across your organization.
          </p>
        </div>
      </div>
    </section>
    ...
    <section className="bg-white py-20 px-4 relative z-10 -mt-8 rounded-t-3xl rounded-b-3xl">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1">
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#21005c] mb-6">
            Boost BI ROI with Embedded Analytics
          </h2>
          <p className="text-lg text-gray-700 mb-8">
            Deliver insights where work happens. Embed Power BI into the tools
            your teams use, with RLS, usage monitoring, and automated
            distribution of paginated reports.
          </p>
    ...
    <section className="bg-white py-20 px-4 relative z-10 mt-8 rounded-t-3xl rounded-b-3xl">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#21005c] mb-6">
            Data-Driven Business Insights with Power BI
          </h2>
          <p className="text-lg text-gray-700 mb-8">
            Reveal the impact of every channel and product with a standardized
            KPI framework. Monitor adoption, performance, and business outcomes
            with Power BI at the center of your decision workflow.
          </p>
          <ThemeButton
            variant="outline"
            size="lg"
    ...
    <section className="bg-[#1f1f1f] py-20 px-4 relative z-10 mt-8 rounded-t-3xl rounded-b-3xl">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        {/* Right: Contact Form */}
        <div className="flex-1">
          <div className="bg-[#F2C811] rounded-2xl p-8">
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-[#1f1f1f] text-white font-bold py-4 px-6 rounded-lg hover:bg-black transition-colors"
              >
                Submit Demo Request
              </button>
