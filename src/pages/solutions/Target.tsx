  ...
  <PageLayout backgroundClass="bg-[#E4002B]">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex-1 text-left text-white max-w-xl">
          <div className="uppercase tracking-widest font-bold text-sm mb-4 text-white/90">
            TARGET RETAIL MEDIA & ANALYTICS PLATFORM
          </div>
          <h1 className="text-5xl lg:text-7xl font-extrabold mb-6">
            AI-POWERED TARGET MARKETING SOLUTIONS
          </h1>
          <p className="text-2xl mb-8 font-light leading-snug">
            Elevate your Target performance with AI-driven insights, automated
            retail media optimization, and data-backed strategies that grow
            market share.
          </p>
          <ThemeButton
            variant="primary"
            size="lg"
            href="/contact-form"
            className="bg-white text-[#E4002B] font-bold rounded-lg shadow-lg border-0 w-[165px] h-[48px] min-w-[165px] min-h-[48px] whitespace-nowrap hover:bg-[#f3f3f3] transition-colors"
          >
            Get in Touch
          </ThemeButton>
        </div>
    ...
    <section className="bg-white py-20 px-4 relative z-20 -mt-16 rounded-t-3xl rounded-b-3xl">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-extrabold text-[#7A0019] mb-6 text-center">
          AI-Driven Target Analytics & Performance Insights
        </h2>
        <p className="text-lg md:text-xl text-center text-gray-700 max-w-3xl mx-auto mb-12">
          Turn Target traffic and sales data into action. We automate retail
          media optimization, provide real-time performance analytics, and
          deliver predictive insights that drive measurable growth on Target.
        </p>
          ...
          <div className="flex-1 w-full">
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b pb-4">
                <span className="font-bold text-xl text-[#7A0019]">
                  Retail Media Optimization for Growth
                </span>
                <span className="text-3xl text-[#E4002B] font-bold">+</span>
              </div>
              <div className="flex items-center justify-between border-b pb-4">
                <span className="font-bold text-xl text-[#7A0019]">
                  Turning Target Trends into Tangible Results
                </span>
                <span className="text-3xl text-[#E4002B] font-bold">+</span>
              </div>
              <div className="flex items-center justify-between border-b pb-4">
              ...
              <div className="flex items-center justify-between">
                <span className="font-bold text-xl text-[#7A0019]">
                  Turning Retail Challenges into Brand Wins
                </span>
                <span className="text-3xl text-[#E4002B] font-bold">+</span>
              </div>
            </div>
    ...
    <section className="bg-white py-20 px-4 relative z-10 mt-8 rounded-t-3xl rounded-b-3xl">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1">
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#7A0019] mb-6">
            AI-Powered Target Analytics & Campaign Optimization
          </h2>
          <p className="text-lg text-gray-700 mb-6">
            Our AI platform transforms Target retail media with intelligent
            automation. We provide real-time bid optimization, budget pacing,
            and predictive analytics that maximize your ROI while reducing
            manual workload.
          </p>
          <p className="text-lg text-gray-700">
            From keyword and audience intelligence to creative testing and
            performance forecasting, our data-driven approach delivers
            measurable results and scalable growth.
          </p>
        </div>
      </div>
    </section>
    ...
    <section className="bg-white py-20 px-4 relative z-10 -mt-8 rounded-t-3xl rounded-b-3xl">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1">
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#7A0019] mb-6">
            Boosting Target ROI with Creative & Advertising
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <ThemeButton
              ...
              size="sm"
              href="/contact-form"
              className="border-[#7A0019] text-[#7A0019] hover:bg-[#7A0019] hover:text-white"
            >
    ...
    <section className="bg-[#FDE7EA] py-20 px-4 relative z-10 mt-8 rounded-t-3xl rounded-b-3xl">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        {/* Left: Illustration */}
        <div className="flex-1 text-[#7A0019]">
        ...
        {/* Right: Contact Form */}
        <div className="flex-1">
          <div className="bg-[#E4002B] rounded-2xl p-8">
            <form className="space-y-6">
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-black">
              ...
              <button
                type="submit"
                className="w-full bg-white text-[#E4002B] font-bold py-4 px-6 rounded-lg hover:bg-[#f3f3f3] transition-colors"
              >
                Submit Demo Request
              </button>
