...
import AmazonInfographic from "@/assests/ChatGPT Image Jul 28, 2025, 08_50_01 PM.png";
import AmazonHeroImage from "@/assests/ChatGPT Image Jul 29, 2025, 12_38_05 PM.png";
import AmazonAnalyticsImage from "@/assests/ChatGPT Image Jul 29, 2025, 01_28_39 PM.png";
import AmazonROIImage from "@/assests/ChatGPT Image Jul 29, 2025, 01_53_14 PM.png";
import AmazonInsightsImage from "@/assests/ChatGPT Image Jul 29, 2025, 02_04_20 PM.png";
  ...
  <PageLayout backgroundClass="bg-[#FF9B2F]">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex-1 text-left text-white max-w-xl">
          ...
          <h1 className="text-5xl lg:text-7xl font-extrabold mb-6">
            AI-POWERED AMAZON MARKETING SOLUTIONS
          </h1>
          <p className="text-2xl mb-8 font-light leading-snug">
            Transform your Amazon business with AI-driven insights, automated
            PPC optimization, and data-driven strategies that scale your brand's
            success.
          </p>
          <ThemeButton
            variant="primary"
    ...
    <section className="bg-white py-20 px-4 relative z-20 -mt-16 rounded-t-3xl rounded-b-3xl">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-extrabold text-center text-[#21005c] mb-6">
          AI-Driven Amazon Analytics & Performance Insights
        </h2>
        <p className="text-lg md:text-xl text-center text-gray-700 max-w-3xl mx-auto mb-12">
          Our AI-powered platform transforms Amazon data into actionable
          intelligence. We automate PPC optimization, provide real-time
          performance analytics, and deliver predictive insights that drive
          measurable growth for your Amazon business.
        </p>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b pb-4">
                <span className="font-bold text-xl text-[#21005c]">
                  PPC Optimization Strategies for Brand Growth
                </span>
                <span className="text-3xl text-[#7c3aed] font-bold">+</span>
              </div>
              <div className="flex items-center justify-between border-b pb-4">
                <span className="font-bold text-xl text-[#21005c]">
                  Turning Amazon Trends into Tangible Business Success
                </span>
                <span className="text-3xl text-[#7c3aed] font-bold">+</span>
              </div>
              <div className="flex items-center justify-between border-b pb-4">
              ...
              <div className="flex items-center justify-between">
                <span className="font-bold text-xl text-[#21005c]">
                  Turning Amazon Challenges into Brand Wins
                </span>
                <span className="text-3xl text-[#7c3aed] font-bold">+</span>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1">
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#21005c] mb-6">
            AI-Powered Amazon Analytics & Campaign Optimization
          </h2>
          <p className="text-lg text-gray-700 mb-6">
            Our AI platform transforms Amazon advertising with intelligent
            automation. We provide real-time PPC optimization, automated bid
            management, and predictive analytics that maximize your Amazon ROI
          ...
          <p className="text-lg text-gray-700">
            ...
            performance to optimize strategies and scale your Amazon business
            efficiently.
          </p>
        </div>
      </div>
    ...
    <section className="bg-white py-20 px-4 relative z-10 -mt-8 rounded-t-3xl rounded-b-3xl">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1">
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#21005c] mb-6">
            Boosting Amazon ROI with Creative & Advertising
          </h2>
          <p className="text-lg text-gray-700 mb-8">
            As an officially certified Amazon agency partner, Trilio delivers
    ...
    <section className="bg-white py-20 px-4 relative z-10 mt-8 rounded-t-3xl rounded-b-3xl">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#21005c] mb-6">
            Data-Driven Amazon Marketing Insights
          </h2>
          <p className="text-lg text-gray-700 mb-8">
            Transform your Amazon marketing with AI-powered analytics that
            reveal the true impact of every campaign. Our advanced platform
            tracks sales, conversion rates, and ROI across all your Amazon
