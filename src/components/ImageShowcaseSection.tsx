    ...
    <section className="w-full pt-8 sm:pt-12 pb-2 sm:pb-3" id="showcase">
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="p-4 sm:p-8 flex justify-center items-center flex-col">
          <h3 className="text-3xl sm:text-4xl font-display font-bold tracking-tight mb-3 sm:mb-4 bg-gradient-to-r from-white via-teal-100 to-teal-200 bg-clip-text text-transparent drop-shadow-lg">
            Unified Ecommerce Intelligence
          </h3>
          <p className="text-gray-100 text-sm sm:text-base text-center">
            Transform scattered data from Shopify, Amazon, Meta, Google, and
            more into actionable insights. Our AI analyzes thousands of metrics
            to surface opportunities that drive real revenue growth.
          </p>
