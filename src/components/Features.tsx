      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="feature-card interactive-element opacity-0 animate-fade-in-up transition-all duration-300 cursor-pointer hover:shadow-lg"
            ...
            >
              ...
              <div className="mt-4 text-channeliq-blue font-medium">
                Learn more →
              </div>
            </div>
          ))}
