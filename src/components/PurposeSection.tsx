...
const PurposeSection = () => {
  ...
  const handleScroll = useCallback(() => {
    ...
    rafId.current = requestAnimationFrame(() => {
      ...
      const progress = sectionRect.top <= 0 ? 
        Math.min(1, Math.abs(sectionRect.top) / (window.innerHeight * 1.5)) : 0;
  ...
  return (
    <div 
      ...
      style={{ height: '200vh' }}
    >
      <section className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-white" id="purpose">
          ...
          <div className="relative flex-1 perspective-1000">
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We connect all your ecommerce data sources into one unified view
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We analyze over 100,000 metrics in real-time to surface what matters
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We empower brands to make <span className="text-[#FC4D0A]">data-driven decisions</span> in minutes, not hours
                  </h3>
                </div>
              </div>
            </div>
